...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-1.5 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4",
        className
      )}
      {...props}
    />
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-destructive min-h-4 text-xs font-normal", className)}
      {...props}
    >
      {content}
    </div>
