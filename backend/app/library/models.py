...
class Library(Base):
    ...
    title_ru: Mapped[str | None] = mapped_column(String, unique=True, index=True, nullable=True)
    title_en: Mapped[str | None] = mapped_column(String, unique=True, index=True, nullable=True)
    ...
    document: Mapped[str | None] = mapped_column(String, index=False, nullable=True)
